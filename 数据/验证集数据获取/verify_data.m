...
% 重新1000开始取值，避免寻找到异常值
rand_A=randi([4501 5000],[50 1]);          % 正常数据样本2408
rand_B=randi([4501 5000],[50 1]);          % 电堆泄露样本2604
rand_C=randi([4501 5000],[50 1]);          % 鼓风机故障样本3012
rand_D=randi([4501 5000],[50 1]);          % 热交换器故障样本2806
...
% writematrix(data_total, 'init_system_data.xlsx');
...
%% 主成分数据
load F:\matalable文件\毕业设计\数据\验证集数据获取\lambda.mat
